...
local CorsHandler = {}
ngx.log(ngx.WARN, "*** in cors handler with priority 900")

CorsHandler.PRIORITY = 900
...
function CorsHandler:access(conf)
    ...
    ngx.log(ngx.WARN, "*** in cors handler access")
  ...
  then
    ngx.log(ngx.WARN, "*** cors: returning early")
    return
  end
  ngx.log(ngx.WARN, "*** cors: proceeding")
